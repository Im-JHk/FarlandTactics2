...
HRESULT ProgressBar::init(int x, int y, int width, int height)
{
    ...
    _progressBarUp = IMAGEMANAGER->addImage("BarUp", "Resources/Images/Object/HpBarUp.bmp", 0, 0, width, height, true, RGB(255, 0, 255));
    _progressBarDown = IMAGEMANAGER->addImage("BarDown", "Resources/Images/Object/HpBarDown.bmp", 0, 0, width, height, true, RGB(255, 0, 255));
...
void ProgressBar::render(void)
{
    ...
    _progressBarUp->render(getMemDC(), _rc.left + _progressBarDown->getWidth() / 2, _y + _progressBarDown->getHeight() / 2, 0, 0, _width, _progressBarDown->getHeight());
}
